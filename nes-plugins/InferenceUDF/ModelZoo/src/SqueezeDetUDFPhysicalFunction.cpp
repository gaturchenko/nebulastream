...
namespace
{
constexpr auto FunctionName = "SQUEEZEDET_UDF";
constexpr auto ModelEnv = "NES_SQUEEZEDET_UDF_MODEL";
constexpr auto ModelPath = "nes-systests/testdata/model/waymo/pretrained/squeezedet/squeezedet.onnx";
...
using SqueezeDetPhysicalFunction = ModelZooUDFPhysicalFunction<outputSize, infer>;
static_assert(PhysicalFunctionConcept<SqueezeDetPhysicalFunction>);
}

PhysicalFunctionRegistryReturnType
PhysicalFunctionGeneratedRegistrar::RegisterSQUEEZEDET_UDFPhysicalFunction(PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 1, "{} function must have exactly one child function", FunctionName);
    return SqueezeDetPhysicalFunction(arguments.childFunctions[0]);
}
