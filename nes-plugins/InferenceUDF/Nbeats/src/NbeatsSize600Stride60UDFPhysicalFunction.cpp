...
namespace
{
constexpr auto FunctionName = "NBEATS_SIZE_600_STRIDE_60_UDF";
constexpr auto ModelEnv = "NES_NBEATS_SIZE_600_STRIDE_60_UDF_MODEL";
constexpr auto ModelPath = "nes-systests/testdata/model/power/pretrained/nbeats/nbeats_size_600_stride_60.onnx";
...
PhysicalFunctionGeneratedRegistrar::RegisterNBEATS_SIZE_600_STRIDE_60_UDFPhysicalFunction(PhysicalFunctionRegistryArguments arguments)
{
