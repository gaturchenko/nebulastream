...
#include "../include/NbeatsUDFPhysicalFunction.hpp"
...
namespace
{
constexpr auto FunctionName = "NBEATS_SIZE_120_STRIDE_12_UDF";
constexpr auto ModelEnv = "NES_NBEATS_SIZE_120_STRIDE_12_UDF_MODEL";
constexpr auto ModelPath = "nes-systests/testdata/model/power/pretrained/nbeats/nbeats_size_120_stride_12.onnx";

std::filesystem::path modelPath()
{
    return nbeatsUdfModelPath(ModelEnv, ModelPath);
}
...
using NbeatsPhysicalFunction = NbeatsUDFPhysicalFunction<outputSize, infer>;
static_assert(PhysicalFunctionConcept<NbeatsPhysicalFunction>);
}

PhysicalFunctionRegistryReturnType
PhysicalFunctionGeneratedRegistrar::RegisterNBEATS_SIZE_120_STRIDE_12_UDFPhysicalFunction(PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 1, "{} function must have exactly one child function", FunctionName);
    return NbeatsPhysicalFunction(arguments.childFunctions[0]);
}
