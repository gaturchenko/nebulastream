...
namespace
{
constexpr auto FunctionName = "NBEATS_SIZE_300_STRIDE_30_UDF";
constexpr auto ModelEnv = "NES_NBEATS_SIZE_300_STRIDE_30_UDF_MODEL";
constexpr auto ModelPath = "nes-systests/testdata/model/power/pretrained/nbeats/nbeats_size_300_stride_30.onnx";
...
PhysicalFunctionGeneratedRegistrar::RegisterNBEATS_SIZE_300_STRIDE_30_UDFPhysicalFunction(PhysicalFunctionRegistryArguments arguments)
{
