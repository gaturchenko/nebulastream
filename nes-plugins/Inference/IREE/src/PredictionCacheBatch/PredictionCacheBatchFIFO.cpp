...
namespace NES
{
PredictionCacheBatchFIFO::PredictionCacheBatchFIFO(
    ...
    : PredictionCacheBatch(numberOfEntries, sizeOfEntry, startOfEntries, hitsRef, missesRef, inputSize), replacementIndex(0)
{
}

nautilus::val<int8_t*>
PredictionCacheBatchFIFO::getDataStructureRef(const nautilus::val<std::byte*>& record, const PredictionCacheBatch::PredictionCacheReplacement& replacementFunction)
{
    ...
    const nautilus::val<PredictionCacheBatchEntry*> predictionCacheEntryToReplace = startOfEntries + replacementIndex * sizeOfEntry;
