...
class OpenVINOInferenceOperator : public PhysicalOperatorConcept
{
public:
    OpenVINOInferenceOperator(
        OperatorHandlerId inferModelHandlerIndex,
...
protected:
    template <class T>
    void performInference(ExecutionContext& executionCtx, Record& record) const;

    template <class T>
    void writeOutputRecord(ExecutionContext& executionCtx, Record& record) const;
