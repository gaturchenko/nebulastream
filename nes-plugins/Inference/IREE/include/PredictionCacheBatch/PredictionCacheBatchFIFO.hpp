...
namespace NES
{
struct PredictionCacheBatchEntryFIFO : PredictionCacheBatchEntry
{
    ~PredictionCacheBatchEntryFIFO() override = default;
};

class PredictionCacheBatchFIFO : public PredictionCacheBatch
{
public:
    PredictionCacheBatchFIFO(
    ...
    ~PredictionCacheBatchFIFO() override = default;
    nautilus::val<int8_t*>
