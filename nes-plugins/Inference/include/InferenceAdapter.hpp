...
public:
    ...
    static std::shared_ptr<InferenceAdapter> create();
    ...
    /// input/output buffers shared across supported inference backends
...
private:
    ...
    Nebuli::Inference::ModelBackend backend = Nebuli::Inference::ModelBackend::OPENVINO;
    std::string functionName;
    IREERuntimeWrapper runtimeWrapper;
    OpenVINORuntimeWrapper openVinoRuntimeWrapper;
    std::unique_ptr<std::byte[]> reducedInferenceOutputData{};
    ...
    std::unordered_map<NES::DataType, ov::element::Type> openVinoDtypeMap = {
