...
namespace NES
{
struct PredictionCacheEntryAlwaysMiss : PredictionCacheEntry
{
    ~PredictionCacheEntryAlwaysMiss() override = default;
};

class PredictionCacheAlwaysMiss : public PredictionCache
{
public:
    PredictionCacheAlwaysMiss(
    ...
    ~PredictionCacheAlwaysMiss() override = default;
