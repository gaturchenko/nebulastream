...
/// Logical color conversion toggle function.
/// Signature: ToggleGrayRgb(image: VARSIZED) -> VARSIZED
/// Input grayscale images are converted to RGB, RGB/RGBA images are converted to grayscale.
class ToggleGrayRgbLogicalFunction final : public LogicalFunctionConcept
{
public:
    static constexpr std::string_view NAME = "ToggleGrayRgb";

    explicit ToggleGrayRgbLogicalFunction(const LogicalFunction& image);
...
FMT_OSTREAM(NES::ToggleGrayRgbLogicalFunction);
