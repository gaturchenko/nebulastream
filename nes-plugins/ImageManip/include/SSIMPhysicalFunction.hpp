...
/// Keeps the previous image and emits either the previous image (if SSIM >= threshold) or the current one (and updates state).
class SSIMPhysicalFunction final : public PhysicalFunctionConcept
{
public:
