...
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64" AND VCPKG_TARGET_IS_LINUX)
  vcpkg_list(APPEND LIBPNG_HARDWARE_OPTIMIZATIONS_OPTION "-DPNG_ARM_NEON=on")
  # VCPKG_CMAKE_SYSTEM_NAME=Linux forces CMake cross-compile mode, leaving
  # CMAKE_SYSTEM_PROCESSOR empty. libpng gates compilation of its arm/*.c NEON
  # sources on that variable, so without this the NEON symbols are referenced
  # (PNG_ARM_NEON=on) but never defined -> undefined-reference link failure.
  vcpkg_list(APPEND LIBPNG_HARDWARE_OPTIMIZATIONS_OPTION "-DCMAKE_SYSTEM_PROCESSOR=aarch64")
endif()
